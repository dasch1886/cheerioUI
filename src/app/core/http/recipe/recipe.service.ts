...
export class RecipeService {
  ...
  filterAdvanced(author?: string, ingredients?: Array<string>): Observable<Array<RecipeModel>> {
    return this.http.get<Array<RecipeModel>>(
      server.address + recipes.uri + filter.uri + 'Advanced', {
        params: {
          author: author,
          array: JSON.stringify(ingredients)
        }
      });
  }
